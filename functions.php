...
function dukan_fonts_url()
{
    ...
    if (!(isset($theme_options['deactivate_google_fonts']) and true == $theme_options['deactivate_google_fonts'])):
...
function dukan_excerpt_more($more)
{
    ...
    // Return Excerpt Text
    if (isset($theme_options['excerpt_text']) and true == $theme_options['excerpt_text']):
        return ' [...]';
    else:
        return '';
    endif;
...
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
    'https://github.com/gupta977/dukan-lite',
    __FILE__,
    'dukan-lite'
);
